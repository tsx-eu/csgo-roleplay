...
public void OnAllPluginsLoaded() {
	...
	PVE_SetInt(id, ESI_AttackDamage,	10);
	PVE_SetInt(id, ESI_MinSkin, 		45);
	PVE_SetInt(id, ESI_MaxSkin, 		74);
	
	PVE_SetFloat(id, ESF_Speed,			250.0);
	PVE_SetFloat(id, ESF_Gravity,		1.0);
	PVE_SetFloat(id, ESF_ScaleSize,		1.0);
	PVE_SetFloat(id, ESF_FeetSize,  	0.0);
	PVE_SetFloat(id, ESF_AttackSpeed,	45/35.0);
	PVE_SetFloat(id, ESF_AttackRange,	RANGE_MELEE);
	
	PVE_AddAnimation(id, EAA_Idle, 		40,	100, 35);
	PVE_AddAnimation(id, EAA_Run, 		41,	 30, 35);
	PVE_AddAnimation(id, EAA_Attack, 	42,  45, 35);
	PVE_AddAnimation(id, EAA_Attack, 	43,  45, 35);
