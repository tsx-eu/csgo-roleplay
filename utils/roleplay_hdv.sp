...
void HDV_Main(int client) {
	...
	menu.AddItem("buy", "Acheter", rp_GetClientBool(client, b_HaveAccount) ? ITEMDRAW_DEFAULT : ITEMDRAW_DISABLED);
	menu.AddItem("history", "Votre historique", rp_GetClientBool(client, b_HaveAccount) ? ITEMDRAW_DEFAULT : ITEMDRAW_DISABLED);
