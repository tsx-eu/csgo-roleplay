...
//#define DEBUG
#define QUEST_UNIQID	"kill-004"
#define QUEST_NAME      "Criminels chez les mercenaires"
...
public void Q1_Start(int objectiveID, int client) {
	...
	menu.AddItem("", "Tuer les plus grands meurtrier en série du serveur.", ITEMDRAW_DISABLED);
	menu.AddItem("", "----------------", ITEMDRAW_DISABLED);
...
public bool IsKillEligible(int attacker, int victim, const char weapon[64]) {
	...
	if( rp_GetClientJobID(victim) == 41 && rp_GetClientInt(victim, i_ToKill) > 0 )
		return true;
